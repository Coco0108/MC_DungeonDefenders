package net.mcreator.dungeondefenders.network;
...
@EventBusSubscriber
public class DungeonDefendersModVariables {
	public static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES = DeferredRegister.create(NeoForgeRegistries.Keys.ATTACHMENT_TYPES, DungeonDefendersMod.MODID);
	public static final Supplier<AttachmentType<PlayerVariables>> PLAYER_VARIABLES = ATTACHMENT_TYPES.register("player_variables", () -> AttachmentType.serializable(() -> new PlayerVariables()).build());

	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		DungeonDefendersMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
		DungeonDefendersMod.addNetworkMessage(PlayerVariablesSyncMessage.TYPE, PlayerVariablesSyncMessage.STREAM_CODEC, PlayerVariablesSyncMessage::handleData);
	}
	...
	public static void clonePlayer(PlayerEvent.Clone event) {
		...
		clone.Mana_Current = original.Mana_Current;
		if (!event.isWasDeath()) {
		}
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>("dungeon_defenders_worldvars", ctx -> new WorldVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>("dungeon_defenders_mapvars", ctx -> new MapVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
		...
		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			...
			IsInGame = nbt.getBooleanOr("IsInGame", false);
			IsCombatPhase = nbt.getBooleanOr("IsCombatPhase", false);
			EnemyLeft = nbt.getDoubleOr("EnemyLeft", 0);
		}
		...
		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			...
			nbt.putBoolean("IsCombatPhase", IsCombatPhase);
			nbt.putDouble("EnemyLeft", EnemyLeft);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DungeonDefendersMod.MODID, "saved_data_sync"));
	...
	public static class PlayerVariables implements ValueIOSerializable {
		boolean _syncDirty = false;
		public double Mana_Max = 20.0;
		public double Mana_Current = 0;

		@Override
		public void serialize(ValueOutput output) {
			output.putDouble("Mana_Max", Mana_Max);
			output.putDouble("Mana_Current", Mana_Current);
		}

		@Override
		public void deserialize(ValueInput input) {
			Mana_Max = input.getDoubleOr("Mana_Max", 0);
			Mana_Current = input.getDoubleOr("Mana_Current", 0);
		}
	...
	public record PlayerVariablesSyncMessage(PlayerVariables data) implements CustomPacketPayload {
		public static final Type<PlayerVariablesSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(DungeonDefendersMod.MODID, "player_variables_sync"));
